  ...
  return (
    <div className="p-4 lg:p-5">
      ...
      >
        ...
        <Link href="/api-log" className="h-8 rounded-md border border-rule-2 px-3 leading-8 text-ink-2 hover:text-ink">
          Reset
        </Link>
      </form>
            ...
            {rows.length === 0 ? (
              ...
              rows.map((r) => (
                <tr key={r._id} className="border-b border-rule last:border-0 hover:bg-sunken">
                  ...
                  <td className="px-3 py-1.5">
                    {r.clientId != null ? (
                      <Link href={`/clients/${r.clientId}`} className="text-ink hover:text-accent">
                  ...
                  <td className="px-3 py-1.5 text-right">
                    <Link href={`/api-log/${r._id}`} className="text-[12px] text-accent hover:underline">
                      view
                    </Link>
                  </td>
                </tr>
