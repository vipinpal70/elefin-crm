...
export default async function TradingHistoryPage({
  ...
  return (
    <div className="p-4 lg:p-5">
      <div className="mb-3">
        <Link
          href={clientId ? `/elefin/clients/${clientId}` : "/elefin/clients"}
      ...
      <form
        method="GET"
        action={`/elefin/accounts/${a._id}/history`}
      ...
      >
        ...
        <Link href={`/elefin/accounts/${a._id}/history`} className="h-8 rounded-md border border-rule-2 px-3 leading-8 text-ink-2 hover:text-ink">
          Reset
        </Link>
        <a
